...
const cadastroUsuario = async (req, res) => {
    ...
    try{
        ...
        const usuarioRegistrado = await conexao.query(query,[nome, email, senhaCriptografada, nome_loja ]);
...
const loginUsuario = async (req, res) => {
    ...
    try{
        ...
        const { rows, rowCount} = await conexao.query(queryVericandoEmail, [email]);
...
const atualizarUsuario = async (req, res) => {
    ...
    try{
        ...
        const queryAtualizar = 'update usuarios set nome = $1, email = $2, senha = $3, nome_loja = $4 where id = $5 RETURNING *'
        const usuarioAtualizado = await conexao.query(queryAtualizar,[nome, email, senhaCriptografada, nome_loja, id ]);
